...
import com.mobbeel.androidevcctwitter.twitter.Tweet;
...
public class TweetsArrayAdapter extends ArrayAdapter<String> implements Response.Listener<TweetData>, Response.ErrorListener {
	 ...
	 * 			Initial dataset.
	 */
	public TweetsArrayAdapter(Context context, TweetData newData) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(tweet != null){
			viewHolder.twitterUserImage.setImageUrl(tweet.getUserImageUrl(), new ImageLoader(RequestManager.getRequestQueue(), null));
	...
	private void loadMoreData(){
		...
		TwitterManager.getInstance().getDefaultHashtagTweets(this, this);
	}
